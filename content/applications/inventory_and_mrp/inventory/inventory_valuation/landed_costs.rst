...
When creating new RfQs, this product can be added as an invoice line as a landed cost. This product
can also be added to vendor bills that are in the draft state.
...
Click the :icon:`fa-cloud-upload` :guilabel:`(cloud with arrow)` icon to manually save and update
the draft bill.
...
.. note::
   ...
   Journal Entries`, and locate the correct entry, by number (i.e. `STJ/2025/XXXXX`).
